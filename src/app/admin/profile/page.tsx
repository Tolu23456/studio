...
import { uploadProfilePicture, updateUserProfileAdmin } from '@/services/user-data';
...
export default function AdminProfilePage() {
  ...
  const handleProfileSave = async (data: ProfileFormData) => {
    ...
    setIsSaving(true);
    try {
      await updateUserProfileAdmin(user.uid, { displayName: data.displayName, isAdmin: userProfile.isAdmin });
      if (refreshUserProfile) await refreshUserProfile();
      toast({
